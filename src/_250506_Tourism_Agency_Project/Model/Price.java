...
public class Price {
    ...
    Price(int id, int hotel_id, int room_id, int accommodation_id, int season_id, int feature_id, int roomfeature_id, int adultGuestNumber, int childGuestNumber, double currentCoefficient, double calculatedPrice) {
        this.id = id;
    ...
    public static double calculateCurrentCoefficient(int room_id) {
        ...
        if(selectedSeason.isSeason_2()) currentCoefficient*=1.5;
        //##Season----------------------------------------------------------
