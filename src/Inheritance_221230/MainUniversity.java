...
public class MainUniversity {
        public static void main(String[] args) {
                ...
                // Academician academician1 = new Academician("Mahmut Hodja", "+905005005050",
                // "mahmut@patika.dev", "CENG", "Associated Proffessor");
                ...
                // CivilServant civilServant1 = new CivilServant("Hafize Mom",
                // "+905005015020304", "haf@patika.dev", "CENG", "24/7");
                // civilServant1.work();

                // Employee civilServant2 = new CivilServant("Body Ekrem", "+905015023456",
                // "body@kodluyoruz.org", "PR", "09-18");
                ...
                // Assistant assistant1 = new Assistant("Assistant Ali", "+905435432121",
                // "intern@patika.dev", "Bootcamp", "Assistant", "10-18");
                ...
                // Employee academician2 = new
                // Academician("Kodluyoruz","+905554443322","a@kodluyoruz.org","Coding","Prof.");
                System.out.println("**************");
                ...
                // Academician [] enteredEmployeeList =
                // {employee1,academician1,lecturer1,assistant1,labAssistant1,civilServant1,IT_Personel1,securityPersonel1};
                // Employee [] enteredEmployeeList =
                // {employee1,academician1,lecturer1,assistant1,labAssistant1,civilServant1,IT_Personel1,securityPersonel1};

                // Employee.whoEnteredUniversity(enteredEmployeeList);

                // Abstraction
                lecturer1.enterCourse("10:00");
                labAssistant1.enterCourse("10:00");
