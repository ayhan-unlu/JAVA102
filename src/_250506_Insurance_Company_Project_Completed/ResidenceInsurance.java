...
public class ResidenceInsurance extends Insurance {
    public ResidenceInsurance(String insuranceName, double insuranceFee, LocalDate startDate, LocalDate endDate) {
        super(insuranceName, 34 * insuranceFee, startDate, endDate);
    ...
    public double calculate(double insuranceFee,int accountTypeMultiplier) {
        insuranceFee = 30 * insuranceFee*accountTypeMultiplier;
        return insuranceFee;
    }
}
