...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * // TreeSet <Account> accountList = new TreeSet<>(new
         * OrderByEmailComparator();)
         * 
         ...
         * //login function working properly aManager.login(g.getEmailInput(),
         * g.getPasswordInput() , list );
